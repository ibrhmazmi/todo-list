...
CREATE TABLE `todo_list` (
  ...
  `task_name` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT NULL,
  `item_completion` int DEFAULT '0',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
...
CREATE TABLE `user` (
  ...
  KEY `fb_idx` (`Facebook_id`),
  KEY `git_idx` (`Github_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2023-09-13  5:01:50
